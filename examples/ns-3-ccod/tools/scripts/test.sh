...
CHECKPOINT_LOAD_PATH="$RLIB_DIR/examples/ns-3-ccod/checkpoints/cd${AGENT}_${SCENARIO}_${N_WIFI}_run_${LAST_RUN}.pkl.lz4"
CHECKPOINT_SAVE_PATH="$RLIB_DIR/examples/ns-3-ccod/checkpoints/${AGENT}_highDensity_${SCENARIO}_${N_WIFI}.pkl.lz4"
